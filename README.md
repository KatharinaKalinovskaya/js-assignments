...
## Javascript Assignments  [![Build Status](https://travis-ci.org/KatharinaKalinovskaya/js-assignments.svg?branch=master)](https://travis-ci.org/KatharinaKalinovskaya/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'KatharinaKalinovskaya'` with your account name).
...
```
* Open https://github.com/KatharinaKalinovskaya/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
